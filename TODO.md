...
1. Portfolio/src/pages/projects.js По этому примеру повсюду изменить логику работы с i18n
2. Добавить падинги на странице ошибок
3. Portfolio/src/pages/company.js Переписать highlightProjects и unHighlightProjects, создать отдельный хук и мапить компани итем
4. Обернуть пустые компоненты в react.memo
5. Обновить реакт до 18 версии
