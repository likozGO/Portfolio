...
1. Добавить кнопку назад со страницы проектов
2. Portfolio/src/pages/projects.js По этому примеру повсюду изменить логику работы с i18n
3. Добавить падинги на странице ошибок
4. Portfolio/src/pages/company.js Переписать highlightProjects и unHighlightProjects, создать отдельный хук и мапить компани итем
5. Обернуть пустые компоненты в react.memo
6. Обновить реакт до 18 версии
7. Проверить все даксы и поудалять лишнее
8. Проверить компоненты и улучшить что увижу
9. Показать пару людям и получить отзывы
10. Добавить полоску с прогрессом (возможно сделать в виде кружка возле лого)
11. Посмотреть методы оптимизации и оптимизировать (анимации, гугл спид инсайтс)
12. Написать тесты для компонентов
13. Написать проптайпсы для всех компонентов
14. Купить домен - задеплоить
15. Добавить container компонент
16. Добавить section компонент
17. Просмотреть дивы - убрать не нужное
18. Изменить название компонентов - "Profile" = "About me" - "Stage controller" = Settings - "Stage hello" = GreetingPage - "Company" = "Experience"
