    ...
    >
      ...
      >
        ...
        <g id="Rack-three">
          ...
          <path
            fill="#2D495E"
            d="M415.1 209.2h18.4v5.8h-18.4z"
          />
          <path
            fill="#195063"
        ...
        <g id="Rack-two">
          ...
          <path
            fill="#0DB58A"
            d="M448.4 145.4h16.1v2.3h-16.1z"
          />
          <path
            fill="#195063"
          ...
          <path
            fill="#195063"
            d="M450.7 154.6h9.2v2.3h-9.2z"
          />
          <path
            fill="#00B284"
            d="M462.2 154.6h2.3v2.3h-2.3z"
          />
        </g>
        <g id="Rack-one">
          <path
          ...
          <path
            fill="#195063"
            d="M479.5 103.3h2.3v13.8h-2.3z"
          />
          <path
            fill="#00B284"
            d="M486.4 103.3h2.3v13.8h-2.3z"
          />
          <path
            fill="#195063"
      ...
      >
        ...
        <circle
          id="smoke-base-1"
          className="smoke"
          style={{ animationDelay: '-0.2s', transformOrigin: '464.3px 78.4px' }}
          cx="464.3"
          cy="78.4"
          r="11.3"
        />
        <circle
          id="smoke-base-3"
          className="smoke"
          style={{ animationDelay: '-0.1s', transformOrigin: '492.9px 83.8px' }}
          cx="492.9"
          cy="83.8"
          r="8.6"
        />
...
export default memo(CrashImage);
